...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2025 at 06:46 AM
...
(191, 'Palace on Herbosa&#039;s raps: Let&#039;s leave it to the Ombudsman', 'palace+on+herbosa+039+s+raps+let+039+s+leave+it+to+the+ombudsman', 'writer_articles', 104, 1, 'Published', '2025-12-05 13:18:15', '', '');
...
(1, '2025-12-05 01:59:09', 'Teacher', 18, '', '/uploads/registration/teacher/license-certification/Erfel  Printing-20251205095909.pdf', '', '/uploads/registration/teacher/agreement/Erfel  Printing-20251205095909.pdf', '', 'Pending', NULL),
(2, '2025-12-05 02:03:29', 'Writer', 18, '', '/uploads/registration/writer/license-certification/Erfel  Printing-20251205100329.', 'https://mb.com.ph/2025/12/05/sustainable-holiday-gift-ideas', '/uploads/registration/writer/agreement/Erfel  Printing-20251205100329.pdf', '', 'Pending', NULL),
(3, '2025-12-05 02:08:46', 'Editor', 18, '', '', 'https://mb.com.ph/2025/12/05/sustainable-holiday-gift-ideas', '/uploads/registration/editor/agreement/Erfel  Printing-20251205100846.pdf', '', 'Pending', NULL),
(4, '2025-12-05 02:38:49', 'Researches', 9, '', '', '', '/uploads/registration/researches/agreement/Holy Infant Academy-20251205103849.pdf', '                                                            sadsafsaf', 'Kept', '2025-12-05 11:47:33');
...
(18, '', 'Erfel', '', 'Printing', 'Erfel  Printing', '', 'Personal', 1, '', '', '2025-11-18', 'Male', '', '', 'DURIPES', 'BACARRA', 'ILOCOS NORTE', 'REGION I', 'Philippines', '', 'Associate Degree Holder', '', '', 'erfelprintingservices@gmail.com', '', 'eps', '$2y$10$I.d83QSfQ/LX5RJkvcG56OYuAToGU17g82TT5GLqpKGBhlqvQEKiC', '', 'Basic User', '', '', '', '', '', '', '', '', 'Verified', 'Revoked', '2025-11-11 16:37:14', 'f5def5aa322491ee0d030f2e8bd6f1e1e0d0733650c34d6f13e5790aefb2c21d', '2025-11-17 19:34:02', 'GCASH', 'ddfdgdsg', 'dfgdgdg', 'fgfxgdfg');
...
--
ALTER TABLE `contents`
  MODIFY `contentId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=192;
...
--
ALTER TABLE `other_registrations`
  MODIFY `otherId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `registrant_activities`
  MODIFY `registrant_activityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=456;
