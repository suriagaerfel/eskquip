...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2025 at 07:09 AM
...
(207, 'fgfchgchgf', 'fgfchgchgf', 'teacher_files', 27, 18, 'Published', '2025-12-07 12:39:32', '', ''),
...
(27, 'fgfchgchgf', 'fgfchgchgf', 'Lesson Plan', 'Free', '', 'cnfghfhdf', '/uploads/thumbnails/teacher-files/27-20251207123930.jpeg', 'pdf', '18', '2025-12-07 12:36:42', '2025-12-07 12:39:32', '2025-12-07 13:58:12', 'Published', 'Not for Sale', 0, '/uploads/documents/teacher/18-66676663686763686766.pdf');
...
--
ALTER TABLE `contents`
  MODIFY `contentId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=211;
...
--
ALTER TABLE `registrant_activities`
  MODIFY `registrant_activityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=516;
...
--
ALTER TABLE `teacher_files`
  MODIFY `teacher_fileId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `writer_article_versions`
  MODIFY `writer_articleVersionId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
