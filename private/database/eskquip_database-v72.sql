...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 24, 2025 at 04:10 AM
...
--
ALTER TABLE `content_performance`
  MODIFY `content_viewId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `registrant_activities`
  MODIFY `registrant_activityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=604;
...
--
ALTER TABLE `writer_article_versions`
  MODIFY `writer_articleVersionId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=575;
