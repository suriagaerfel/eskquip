...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2025 at 12:07 PM
...
(224, 'dssdgsdg', 'dssdgsdg', 'teacher_files', 30, 1, 'Published', '2025-12-11 11:04:34', '', ''),
...
(229, 'sdfgfdh', 'sdfgfdh', 'teacher_files', 33, 1, 'Published', '2025-12-12 20:03:43', '', ''),
...
(1, '2025-12-11 13:22:06', 'teacher_files', 31, 1, 31, '2025-12-12 14:04:33'),
(2, '2025-12-11 15:26:47', 'teacher_files', 28, 1, 29, '2025-12-13 11:19:00'),
(3, '2025-12-13 06:51:01', 'teacher_files', 30, 1, 2, '2025-12-13 06:51:03'),
...
(9, '2025-12-13 13:56:18', 'writer_articles', 119, 1, 839, '2025-12-14 10:06:12'),
(10, '2025-12-13 14:15:46', 'teacher_files', 33, 1, 72, '2025-12-13 14:21:10'),
...
(16, '2025-12-14 09:18:08', 'writer_articles', 116, 1, 18, '2025-12-14 09:19:01'),
...
(30, 'dssdgsdg', 'dssdgsdg', 'Syllabus', 'Purchased', '', 'dsfsdgfgdfgsdg', '/uploads/thumbnails/teacher-files/30-20251211110355.jpeg', 'pdf', '1', '2025-12-11 11:03:41', '2025-12-11 11:04:34', '2025-12-13 14:50:59', 'Published', 'Not for Sale', 10, '/uploads/documents/teacher/1-6473736467736467.pdf'),
...
(101, 'About Us', 'about+us', '', 'Administrative', 'About Us', 1, 'Erfel Contiga Suriaga', '', '2025-12-01 20:05:29', '2025-12-13 14:56:31', '2025-12-01 20:05:30', '            This is our about page...        ', 11, 'Unpublished', ''),
...
--
ALTER TABLE `contents`
  MODIFY `contentId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=239;
...
--
ALTER TABLE `developer_tools`
  MODIFY `developer_toolId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `developer_uploaded_files`
  MODIFY `developer_uploadedFileId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `registrant_activities`
  MODIFY `registrant_activityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=575;
...
--
ALTER TABLE `school_researches`
  MODIFY `school_researchId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `teacher_files`
  MODIFY `teacher_fileId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `writer_articles`
  MODIFY `writer_articleId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;

--
-- AUTO_INCREMENT for table `writer_article_versions`
--
ALTER TABLE `writer_article_versions`
  MODIFY `writer_articleVersionId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=519;
