...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2025 at 04:29 PM
...
(193, 'sdgfhfdh', 'sdgfhfdh', 'teacher_files', 20, 18, 'Unpublished', '2025-12-06 14:51:42', '', ''),
...
(18, '', 'Erfel', '', 'Printing', 'Erfel  Printing', '', 'Personal', 1, '', '', '2025-11-18', 'Male', '', '', 'DURIPES', 'BACARRA', 'ILOCOS NORTE', 'REGION I', 'Philippines', '', 'Associate Degree Holder', '', '', 'erfelprintingservices@gmail.com', '', 'eps', '$2y$10$I.d83QSfQ/LX5RJkvcG56OYuAToGU17g82TT5GLqpKGBhlqvQEKiC', '', 'Basic User', 'Teacher', '', '', '', '', '', '', '', 'Verified', 'Revoked', '2025-11-11 16:37:14', 'f5def5aa322491ee0d030f2e8bd6f1e1e0d0733650c34d6f13e5790aefb2c21d', '2025-11-17 19:34:02', '', 'ddfdgdsg', 'dfgdgdg', '');
...
(20, 'sdgfhfdh', 'sdgfhfdh', 'Lesson Plan', 'Free', '', 'gdsgsdggsdgdsfsdgsdgdsg', '/uploads/file-thumbnails/20-20251206225055.jpeg', 'pdf', '18', '2025-12-06 14:50:50', '2025-12-06 14:51:42', '2025-12-06 23:13:58', 'Unpublished', 'Not for Sale', 0, '/uploads/documents/teacher/18-7364676668666468.pdf'),
...
--
ALTER TABLE `contents`
  MODIFY `contentId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=197;

--
-- AUTO_INCREMENT for table `content_performance`
--
ALTER TABLE `content_performance`
  MODIFY `content_viewId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `registrant_activities`
  MODIFY `registrant_activityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=490;
...
--
ALTER TABLE `school_researches`
  MODIFY `school_researchId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `teacher_files`
--
ALTER TABLE `teacher_files`
  MODIFY `teacher_fileId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `writer_articles`
  MODIFY `writer_articleId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;

--
-- AUTO_INCREMENT for table `writer_article_versions`
--
ALTER TABLE `writer_article_versions`
  MODIFY `writer_articleVersionId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
