...
<div class="modal website-modal website-modal-wrapper" id="modal-subscription">
    <div class="website-modal-content">
        <a class="close close-without-null-redirection">&times;</a>
                            ...
                            <input type="number" placeholder="<?php if ($type=='Personal') {echo 'Number of Months';} if ($type=='School') {echo 'Number of Years';}?>" value="<?php echo $duration?>" min="1" id="subscription-duration">
                            

                            <select id="subscription-payment-option">
                            ...
                            <input type="text" placeholder="Your Reference Number" value="<?php echo $referenceNumber?>" id="subscription-reference-number">
                            
                            <label for="proofOfPayment">Proof of Payment [JPEG or JPG format]</label>
                            <input type="file" value="<?php echo $proofOfPayment?>" id="subscription-proof-of-payment">
                ...
                <div id="modal-other-registration-inputs-container">
                    ...
                    <div class="modal-other-registration-submitted-documents-container">
                       <small>Your Submissions: </small>
                        <?php if ($regType == 'teacher') {?>
                        <a href="<?php echo '/private'.$recordedRegistration['otherLicenseCertification']?>"class="link-tag-button">License or Certification</a>
                        <?php } ?>
                        ...
                        <a href="<?php echo '/private'.$recordedRegistration['otherAgreement']?>"class="link-tag-button">Agreement</a>
                      </div>
                    <?php }?>  
                </div>
