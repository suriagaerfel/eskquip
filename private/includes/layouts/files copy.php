<form  class="actual-workspace" method="post"  enctype="multipart/form-data" action="../../private/includes/processing/file-processing.php"> 
    ...
    <div class="file-content-container">
        ...
        <div id="file-category-access-type-amount-shared-with-container">
            ...
            <input type="text" placeholder="Amount" name="amount" id="file-amount" value="<?php echo $amount?>" id="file-amount" hidden>
    ...
    <div id="file-actions-container" class="workspace-actions-container">
                ...
                <div class="workspace-action-buttons">
                    ...
                    <a class="link-tag-button" href="../../private/includes/processing/update-teacher-file-info-processing.php?publish=<?php echo $fileToEdit?>" title="Publish">Publish</a>
                    <?php }?>

                    <?php if($status=="Published") {?>
                    <a class="link-tag-button" href="../../private/includes/processing/update-teacher-file-info-processing.php?unpublish=<?php echo $fileToEdit?>"  title="Unpublish">Unpublish</a>
                    <?php }?>

                    <?php if ($sellerSubscribed ) {?>
                    <?php if($forSale=="Not for Sale" && $status=="Published" && $accessType=='Purchased' && $filledOutSellingDetails && $amount) {?>
                    <a class="link-tag-button" href="../../private/includes/processing/update-teacher-file-info-processing.php?sell=<?php echo $fileToEdit?>" title="Sell">Sell</a>
                    <?php }?>
                    <?php if($forSale=="For Sale") {?>
                    <a class="link-tag-button" href="../../private/includes/processing/update-teacher-file-info-processing.php?unsell=<?php echo $fileToEdit?>" title="Unsell">Unsell</a>
                    <?php }?>

                    <?php } ?>
                    
                    <?php if ($status != 'Published') {?>
                    <a class="link-tag-button" href="?edit=yes&file=<?php echo $fileToEdit?>&confirm-delete=enabled" title="Delete">Delete</a> 
                    <?php } ?>
